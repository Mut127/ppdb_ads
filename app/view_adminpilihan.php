        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <a href='index.php?page=insert_adminpilihan' class="btn btn-info">TAMBAH DATA</a>
                        <br></br>
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            while($row = mysqli_fetch_array($query)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href='?page=update_adminpilihan&upd=$row[id_pilihan]'> Edit </a> &nbsp;
                                        <a href='?page=view_adminpilihan&id_pilihan=$row[id_pilihan]'> Hapus </a>
                                    </td>
                                </tr>
                                ";
                                $no++;
